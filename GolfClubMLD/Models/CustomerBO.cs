...
namespace GolfClubMLD.Models
{
    public class CustomerBO
    {
        ...
        [StringLength(100, ErrorMessage = "Lozinka \"{0}\" mora imati {2} karaktera"), MinLength(8)]
        [RegularExpression(@"^([a-zA-Z0-9@*#]{8,15})$" , ErrorMessage = "Lozinka mora da sadrzi 8 karaktera, velika slova, mala slova i sprecijalne karaktere")]
        ...
        [RegularExpression(@"([+]?381[.-\s]?)?(6\d{1})\d{7,9}")]
